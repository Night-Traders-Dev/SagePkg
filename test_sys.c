...
static SageSlot sage_global_platform_1;

int main(void) {
    sage_global_platform_1 = sage_slot_undefined();
    SageSlot* sage_gc_global_roots[1] = {&sage_global_platform_1};
    SageGcFrame sage_gc_main_frame;
    sage_gc_push_frame(&sage_gc_main_frame, sage_gc_global_roots, 1);
    sage_define_slot(&sage_global_platform_1, sage_string("linux"));
    sage_print_ln(sage_index(sage_nil(), sage_string("platform")));
return 1;
}
