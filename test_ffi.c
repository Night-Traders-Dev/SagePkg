...
static SageSlot sage_global_user_3;
static SageSlot sage_global_getenv_ptr_2;
static SageSlot sage_global_libc_1;

int main(void) {
    sage_global_user_3 = sage_slot_undefined();
    sage_global_getenv_ptr_2 = sage_slot_undefined();
    sage_global_libc_1 = sage_slot_undefined();
    SageSlot* sage_gc_global_roots[3] = {&sage_global_user_3, &sage_global_getenv_ptr_2, &sage_global_libc_1};
    SageGcFrame sage_gc_main_frame;
    sage_gc_push_frame(&sage_gc_main_frame, sage_gc_global_roots, 3);
    sage_define_slot(&sage_global_libc_1, sage_nil());
return 1;
}
