# json.sage - SagePkg bundled copy of lib/json.sage
# CANONICAL SOURCE: lib/json.sage
# Do not edit this file directly. Run `make sync-deps` to propagate changes from lib/.
# ---------------------------------------------------------------------------
