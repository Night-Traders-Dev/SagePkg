...
static SageValue sage_fn_get_user_host_9();
static SageValue sage_fn_get_mem_info_8();
static SageValue sage_fn_get_cpu_info_7();
static SageValue sage_fn_get_uptime_info_6();
static SageValue sage_fn_get_kernel_info_5();
static SageValue sage_fn_get_os_info_4();
static SageValue sage_fn_read_proc_file_3(SageValue arg0);
static SageValue sage_fn_split_lines_2(SageValue arg0);
static SageValue sage_fn_trim_1(SageValue arg0);

static SageSlot sage_global_line_25;
static SageSlot sage_global_i_24;
static SageSlot sage_global_max_lines_23;
static SageSlot sage_global_info_22;
static SageSlot sage_global_dash_21;
static SageSlot sage_global_user_host_line_20;
static SageSlot sage_global_logo_19;
static SageSlot sage_global_YELLOW_18;
static SageSlot sage_global_MAGENTA_17;
static SageSlot sage_global_RED_16;
static SageSlot sage_global_CYAN_15;
static SageSlot sage_global_BLUE_14;
static SageSlot sage_global_GREEN_13;
static SageSlot sage_global_BOLD_12;
static SageSlot sage_global_RESET_11;
static SageSlot sage_global_ESC_10;

static SageValue sage_fn_trim_1(SageValue arg0) {
    SageSlot sage_local_i_30 = sage_slot_undefined();
    SageSlot sage_local_result_29 = sage_slot_undefined();
    SageSlot sage_local_end_idx_28 = sage_slot_undefined();
    SageSlot sage_local_start_idx_27 = sage_slot_undefined();
    SageSlot sage_param_s_26 = sage_slot_undefined();
    SageSlot* sage_gc_roots[5] = {&sage_local_i_30, &sage_local_result_29, &sage_local_end_idx_28, &sage_local_start_idx_27, &sage_param_s_26};
    SageGcFrame sage_gc_frame;
    sage_gc_push_frame(&sage_gc_frame, sage_gc_roots, 5);
    sage_define_slot(&sage_param_s_26, arg0);
    if (sage_truthy(sage_eq(sage_load_slot(&sage_param_s_26, "s"), sage_nil()))) {
        return sage_gc_return(&sage_gc_frame, sage_string(""));
    }
    sage_define_slot(&sage_local_start_idx_27, sage_number(0));
    while (sage_truthy(sage_and(sage_lt(sage_load_slot(&sage_local_start_idx_27, "start_idx"), sage_len(sage_load_slot(&sage_param_s_26, "s"))), sage_or(sage_or(sage_or(sage_eq(sage_index(sage_load_slot(&sage_param_s_26, "s"), sage_load_slot(&sage_local_start_idx_27, "start_idx")), sage_string(" ")), sage_eq(sage_index(sage_load_slot(&sage_param_s_26, "s"), sage_load_slot(&sage_local_start_idx_27, "start_idx")), sage_string("\n"))), sage_eq(sage_index(sage_load_slot(&sage_param_s_26, "s"), sage_load_slot(&sage_local_start_idx_27, "start_idx")), sage_string("\r"))), sage_eq(sage_index(sage_load_slot(&sage_param_s_26, "s"), sage_load_slot(&sage_local_start_idx_27, "start_idx")), sage_string("\t")))))) {
        (void)sage_assign_slot(&sage_local_start_idx_27, "start_idx", sage_add(sage_load_slot(&sage_local_start_idx_27, "start_idx"), sage_number(1)));
    }
    sage_define_slot(&sage_local_end_idx_28, sage_sub(sage_len(sage_load_slot(&sage_param_s_26, "s")), sage_number(1)));
    while (sage_truthy(sage_and(sage_gte(sage_load_slot(&sage_local_end_idx_28, "end_idx"), sage_load_slot(&sage_local_start_idx_27, "start_idx")), sage_or(sage_or(sage_or(sage_eq(sage_index(sage_load_slot(&sage_param_s_26, "s"), sage_load_slot(&sage_local_end_idx_28, "end_idx")), sage_string(" ")), sage_eq(sage_index(sage_load_slot(&sage_param_s_26, "s"), sage_load_slot(&sage_local_end_idx_28, "end_idx")), sage_string("\n"))), sage_eq(sage_index(sage_load_slot(&sage_param_s_26, "s"), sage_load_slot(&sage_local_end_idx_28, "end_idx")), sage_string("\r"))), sage_eq(sage_index(sage_load_slot(&sage_param_s_26, "s"), sage_load_slot(&sage_local_end_idx_28, "end_idx")), sage_string("\t")))))) {
        (void)sage_assign_slot(&sage_local_end_idx_28, "end_idx", sage_sub(sage_load_slot(&sage_local_end_idx_28, "end_idx"), sage_number(1)));
    }
    if (sage_truthy(sage_lt(sage_load_slot(&sage_local_end_idx_28, "end_idx"), sage_load_slot(&sage_local_start_idx_27, "start_idx")))) {
        return sage_gc_return(&sage_gc_frame, sage_string(""));
    }
    sage_define_slot(&sage_local_result_29, sage_string(""));
    {
        SageValue sage_iter_i_31 = sage_range1(sage_add(sage_sub(sage_load_slot(&sage_local_end_idx_28, "end_idx"), sage_load_slot(&sage_local_start_idx_27, "start_idx")), sage_number(1)));
        if (sage_iter_i_31.type == SAGE_TAG_ARRAY) {
            for (int sage_idx_i_32 = 0; sage_idx_i_32 < sage_iter_i_31.as.array->count; sage_idx_i_32++) {
                sage_define_slot(&sage_local_i_30, sage_iter_i_31.as.array->elements[sage_idx_i_32]);
                    (void)sage_assign_slot(&sage_local_result_29, "result", sage_add(sage_load_slot(&sage_local_result_29, "result"), sage_index(sage_load_slot(&sage_param_s_26, "s"), sage_add(sage_load_slot(&sage_local_start_idx_27, "start_idx"), sage_load_slot(&sage_local_i_30, "i")))));
            }
        } else if (sage_iter_i_31.type == SAGE_TAG_STRING) {
            int _len = (int)strlen(sage_iter_i_31.as.string);
            for (int sage_idx_i_32 = 0; sage_idx_i_32 < _len; sage_idx_i_32++) {
                char _ch[2] = {sage_iter_i_31.as.string[sage_idx_i_32], '\0'};
                sage_define_slot(&sage_local_i_30, sage_string(_ch));
                    (void)sage_assign_slot(&sage_local_result_29, "result", sage_add(sage_load_slot(&sage_local_result_29, "result"), sage_index(sage_load_slot(&sage_param_s_26, "s"), sage_add(sage_load_slot(&sage_local_start_idx_27, "start_idx"), sage_load_slot(&sage_local_i_30, "i")))));
            }
        }
    }
    return sage_gc_return(&sage_gc_frame, sage_load_slot(&sage_local_result_29, "result"));
    return sage_gc_return(&sage_gc_frame, sage_nil());
}

static SageValue sage_fn_split_lines_2(SageValue arg0) {
    SageSlot sage_local_i_36 = sage_slot_undefined();
    SageSlot sage_local_current_35 = sage_slot_undefined();
    SageSlot sage_local_lines_34 = sage_slot_undefined();
    SageSlot sage_param_s_33 = sage_slot_undefined();
    SageSlot* sage_gc_roots[4] = {&sage_local_i_36, &sage_local_current_35, &sage_local_lines_34, &sage_param_s_33};
    SageGcFrame sage_gc_frame;
    sage_gc_push_frame(&sage_gc_frame, sage_gc_roots, 4);
    sage_define_slot(&sage_param_s_33, arg0);
    sage_define_slot(&sage_local_lines_34, sage_make_array(0, NULL));
    if (sage_truthy(sage_eq(sage_load_slot(&sage_param_s_33, "s"), sage_nil()))) {
        return sage_gc_return(&sage_gc_frame, sage_load_slot(&sage_local_lines_34, "lines"));
    }
    sage_define_slot(&sage_local_current_35, sage_string(""));
    {
        SageValue sage_iter_i_37 = sage_range1(sage_len(sage_load_slot(&sage_param_s_33, "s")));
        if (sage_iter_i_37.type == SAGE_TAG_ARRAY) {
            for (int sage_idx_i_38 = 0; sage_idx_i_38 < sage_iter_i_37.as.array->count; sage_idx_i_38++) {
                sage_define_slot(&sage_local_i_36, sage_iter_i_37.as.array->elements[sage_idx_i_38]);
                    if (sage_truthy(sage_eq(sage_index(sage_load_slot(&sage_param_s_33, "s"), sage_load_slot(&sage_local_i_36, "i")), sage_string("\n")))) {
                        (void)sage_push(sage_load_slot(&sage_local_lines_34, "lines"), sage_load_slot(&sage_local_current_35, "current"));
                        (void)sage_assign_slot(&sage_local_current_35, "current", sage_string(""));
                    }
                    else {
                        (void)sage_assign_slot(&sage_local_current_35, "current", sage_add(sage_load_slot(&sage_local_current_35, "current"), sage_index(sage_load_slot(&sage_param_s_33, "s"), sage_load_slot(&sage_local_i_36, "i"))));
                    }
            }
        } else if (sage_iter_i_37.type == SAGE_TAG_STRING) {
            int _len = (int)strlen(sage_iter_i_37.as.string);
            for (int sage_idx_i_38 = 0; sage_idx_i_38 < _len; sage_idx_i_38++) {
                char _ch[2] = {sage_iter_i_37.as.string[sage_idx_i_38], '\0'};
                sage_define_slot(&sage_local_i_36, sage_string(_ch));
                    if (sage_truthy(sage_eq(sage_index(sage_load_slot(&sage_param_s_33, "s"), sage_load_slot(&sage_local_i_36, "i")), sage_string("\n")))) {
                        (void)sage_push(sage_load_slot(&sage_local_lines_34, "lines"), sage_load_slot(&sage_local_current_35, "current"));
                        (void)sage_assign_slot(&sage_local_current_35, "current", sage_string(""));
                    }
    ...
    if (sage_truthy(sage_gt(sage_len(sage_load_slot(&sage_local_current_35, "current")), sage_number(0)))) {
        (void)sage_push(sage_load_slot(&sage_local_lines_34, "lines"), sage_load_slot(&sage_local_current_35, "current"));
    }
    return sage_gc_return(&sage_gc_frame, sage_load_slot(&sage_local_lines_34, "lines"));
    return sage_gc_return(&sage_gc_frame, sage_nil());
...
static SageValue sage_fn_read_proc_file_3(SageValue arg0) {
    SageSlot sage_local_content_41 = sage_slot_undefined();
    SageSlot sage_local_tmp_40 = sage_slot_undefined();
    SageSlot sage_param_path_39 = sage_slot_undefined();
    SageSlot* sage_gc_roots[3] = {&sage_local_content_41, &sage_local_tmp_40, &sage_param_path_39};
    SageGcFrame sage_gc_frame;
    sage_gc_push_frame(&sage_gc_frame, sage_gc_roots, 3);
    sage_define_slot(&sage_param_path_39, arg0);
    sage_define_slot(&sage_local_tmp_40, sage_string("/tmp/sage_proc_tmp"));
    (void)sage_call_method(sage_nil(), "exec", 1, (SageValue[]){sage_nil()});
    return sage_gc_return(&sage_gc_frame, sage_nil());
}
