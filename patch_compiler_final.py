...
# 3. prelude implementations
prelude_marker = '            "static SageValue sage_input_fn(SageValue prompt) {\n"'
new_implementations = '''            "static SageValue sage_exec(SageValue cmd) {\n"
...
content = content.replace(prelude_marker, new_implementations)
